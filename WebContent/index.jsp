				...
				<div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
					<div class="sl-slide-inner">
						...
						<div class="slide-content">
							...
							<p><a href="jobs.jsp" class="btn btn-lg btn-default">Find a job</a></p>
						</div>
					</div>
				</div>
				...
				<div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
					<div class="sl-slide-inner">
						...
						<div class="slide-content">
							...
							<p><a href="candidates.jsp" class="btn btn-lg btn-default">Post a job</a></p>
						</div>
					</div>
				</div>
				...
				<div class="sl-slide" data-orientation="vertical" data-slice1-rotation="-5" data-slice2-rotation="25" data-slice1-scale="2" data-slice2-scale="1">
					<div class="sl-slide-inner">
						...
						<div class="slide-content">
							...
							<p><a href="candidates.jsp" class="btn btn-lg btn-default">Find a cadidate</a></p>
						</div>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<p><a href="about.jsp" class="btn btn-primary">Learn More</a></p>
					</div>
					<div class="col-sm-6">
				...
				<div class="row pricing">
					<div class="col-sm-3">
						<ul>
							...
							<li><a href="post-a-job.jsp" class="btn btn-primary">Choose</a></li>
						</ul>
					</div>
					<div class="col-sm-3">
						<ul class="popular">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						...
						<p><a href="testimonials.jsp" class="btn btn-primary">Read All</a></p>
					</div>
				</div>
			</div>
		</section>
					...
					<div class="col-sm-12">
						<div class="owl-carousel">
							...
							<div>
								...
								<p><a href="post.jsp" class="btn btn-primary">Read more</a></p>
							</div>
				...
				<div class="row text-center">
					<div class="col-sm-12">
						...
						<div class="owl-carousel">
							...
							<!-- Logo 1 -->
							<div>
								<a href="company.jsp"><img src="http://placehold.it/133x69.gif" alt="" /></a>
							</div>
